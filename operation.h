...
public:
    ...
    std::string path_lidar1 = "/commander/tools/LidarCalibrationGUI_qt/data/lidar1_data.txt";
    std::string path_lidar2 = "/commander/tools/LidarCalibrationGUI_qt/data/lidar2_data.txt";
